 ...
 */
public class GoodsDetailFragmentKill extends Fragment implements View.OnClickListener {
    ...
    private ProductDetailskillActivity activity;
    private GoodsConfigFragmentKill goodsConfigFragment;
