...
public class Data  {
    ...
    public void setProductItemListid(String productItemListid) {
        this.productItemListid = productItemListid;
    }

    public String getProductItemListsalePrice() {
        return productItemListsalePrice;
    }

    public void setProductItemListsalePrice(String productItemListsalePrice) {
        this.productItemListsalePrice = productItemListsalePrice;
    }
