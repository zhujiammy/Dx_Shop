...
public class PendingPayment extends Fragment implements OnRefreshListener,OnLoadMoreListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        loaddata();
        context=getActivity();
        adapter=new PendingPaymentAdapter(PendingPayment.this,getData());
        return view;
    }
...
/*
    ...
    private void loaddata(){
        ...
        if(netWorkUtils.isNetworkConnected(getActivity())){
            new HttpUtils().GetOrderStatu(Constant.APPURLS+"order/list?orderStatus=01",TOKEN,loginUserId,new HttpUtils.HttpCallback() {
                @Override
                public void onSuccess(String data) {
                    // TODO Auto-generated method stub
                    com.example.zhujia.dx_shop.Tools.Log.printJson("tag",data,"header");
