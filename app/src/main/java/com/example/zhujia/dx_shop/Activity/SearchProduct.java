...
//查询列表
public class SearchProduct extends AppCompatActivity implements View.OnClickListener ,OnRefreshListener,OnLoadMoreListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.searchroduct);
    ...
    private void initUI(){
        ...
        recyclerView.inits(new LinearLayoutManager(SearchProduct.this),this,this);
        ...
        if(goodsType!=0){
            DividerItemDecoration divider = new DividerItemDecoration(SearchProduct.this,DividerItemDecoration.VERTICAL);
            divider.setDrawable(ContextCompat.getDrawable(SearchProduct.this,R.drawable.reccyclerviewf));
    ...
    private void loaddata(){
        new HttpUtils().Get(Constant.APPURLS+"product/search?keyWord="+keyword+"&startRow=0&pageSize=20",new HttpUtils.HttpCallback() {
            @Override
            ...
            public void handleMessage(Message msg) {
                ...
                try{
                    switch (msg.what) {
                        ...
                        case 0:
                            ...
                            adapter.setOnitemClickListener(new GoodsListRecyclerViewAdapter.OnitemClickListener() {
                                ...
                                public void onItemClick(View view, int position) {
                                    intent =new Intent(SearchProduct.this,ProductDetailsActivity.class);
                        ...
                        default:
                            Toast.makeText(SearchProduct.this, "网络异常", Toast.LENGTH_SHORT).show();
                            break;
                    }
    ...
    private void fillDataToList(JSONArray data) throws JSONException {
        ...
        for (int i = 0; i < data.length(); i++) {
            ...
            rechargData.setModel_title(object.getString("model_name"));
        ...
        switch (v.getId()){
            case R.id.iv_goods_type://切换布局
                if (goodsType==0)
                {
                    ...
                    //1：设置布局类型
                    loaddata();
                    adapter = new GoodsListRecyclerViewAdapter(getData(),SearchProduct.this);
                    adapter.notifyDataSetChanged();
                    adapter.setType(1);
                    //2：设置对应的布局管理器
                    recyclerView.inits(new GridLayoutManager(SearchProduct.this,2),this,this);
                    //3：刷新adapter
                    adapter.notifyDataSetChanged();
                    goodsType=1;
                    flag=true;
