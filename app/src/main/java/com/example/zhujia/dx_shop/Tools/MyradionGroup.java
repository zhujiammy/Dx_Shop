 ...
 *
 * 原生 RadioGroup 内的 RadioButton 只能横排或者竖排，并且在嵌套 LinearLayout 等布局后单选功能失效。

 */

public class MyradionGroup extends LinearLayout {

    private static final String TAG = MyradionGroup.class.getSimpleName();
     ...
     * {@inheritDoc}
     */
    public MyradionGroup(Context context) {
        super(context);
     ...
     * {@inheritDoc}
     */
    public MyradionGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new MyradionGroup.LayoutParams(getContext(), attrs);
    }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof MyradionGroup.LayoutParams;
    }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(MyradionGroup.class.getName());
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        info.setClassName(MyradionGroup.class.getName());
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void setIdAndOnCheckedChangeListener(RadioButton rb){
            ...
            if (checkedCount > 1) {
                MyradionGroup.this.removeAllViews();
            }
        ...
        public void onChildViewAdded(View parent, View child) {
            ...
            if (parent == MyradionGroup.this && child instanceof RadioButton) {

                setIdAndOnCheckedChangeListener((RadioButton) child);

            } else if (parent == MyradionGroup.this && child instanceof ViewGroup) {
