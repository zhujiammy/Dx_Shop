...
public class DatabaseHelper extends SQLiteOpenHelper// 继承SQLiteOpenHelper类
{
    ...
    // 数据库名
    private static final String DATABASE_NAME = "DXRacer.db";

    // 数据表名，一个数据库中可以有多个表（虽然本例中只建立了一个表）
    public static final String TABLE_NAME = "PermissionTable";
    ...
    public DatabaseHelper(Context context)
    {
        ...
        Log.d("log", "DatabaseHelper Constructor");
    ...
    public void onCreate(SQLiteDatabase db)
    {
        ...
        Log.d("log", "DatabaseHelper onCreate");
        ...
        sBuffer.append("[shiro_code] TEXT,");
        sBuffer.append("[parentId] INTEGER,");
        sBuffer.append("[resoueceName] TEXT)");
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion)
    {
        ...
        Log.d("log", "DatabaseHelper onUpgrade");
    ...
    public void onOpen(SQLiteDatabase db)
    {
        ...
        Log.d("log", "DatabaseHelper onOpen");
    }
