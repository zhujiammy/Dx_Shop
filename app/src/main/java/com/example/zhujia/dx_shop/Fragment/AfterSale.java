...
import com.example.zhujia.dx_shop.Adapter.AfterSaleAdapter;
import com.example.zhujia.dx_shop.Adapter.AllOrderAdapter;
import com.example.zhujia.dx_shop.Adapter.CompletedAdapter;
...
public class AfterSale extends Fragment implements OnRefreshListener,OnLoadMoreListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.aftersale,container,false);
        initUI();
        ...
        loaddata();
        context=getActivity();
        adapter=new AfterSaleAdapter(AfterSale.this,getData());
        return view;
    }
...
/*
    ...
    private void loadorderstatu(){
        new HttpUtils().GetOrderStatu(Constant.APPURLS+"refund/enums",TOKEN,loginUserId,new HttpUtils.HttpCallback() {
            @Override
    ...
    private void loaddata(){
        ...
        if(netWorkUtils.isNetworkConnected(getActivity())){
            new HttpUtils().GetOrderStatu(Constant.APPURLS+"refund/getRefundOrderList",TOKEN,loginUserId,new HttpUtils.HttpCallback() {
                @Override
                public void onSuccess(String data) {
                    // TODO Auto-generated method stub
