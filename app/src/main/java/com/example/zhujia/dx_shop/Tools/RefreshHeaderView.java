...
public class RefreshHeaderView extends FrameLayout implements SwipeRefreshTrigger,SwipeTrigger   {
    ...
    public void onRefresh() {
        //下拉到一定位置松开之后，调用此方法
        tvTip.setText(getResources().getString(R.string.Refreshing));
    ...
    public void onPrepare() {
        //下拉之前调用此方法
        tvTip.setText(getResources().getString(R.string.refresh));
    ...
    public void onMove(int yScrolled, boolean isComplete, boolean automatic) {
        if (!isComplete) {
            ...
            if (yScrolled >= getHeight()) {
                ...
                tvTip.setText(getResources().getString(R.string.release));
    ...
    public void onComplete() {
        //加载完成之后调用此方法
        tvTip.setText(getResources().getString(R.string.Refreshfinish));
